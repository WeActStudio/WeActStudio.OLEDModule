...
//=======================================================================//
#define BMP_DATA_BUFFER_SIZE (256)
...
HMI_ENGINE_RESULT InitializeHMIEngineObj(void)
{
...
#else
    /* Initialize display size. */
    g_stDeviceInterface.stSize.iWidth = OLED_SIZE_WIDTH;
    g_stDeviceInterface.stSize.iHeight = OLED_SIZE_HEIGHT;
    /* Initialize interface object. */
    ...
    do
    {
        ...
        // eProcessResult = HMI_ActiveEngine(&g_stDemoEngine, g_stHMIDemo_RealtimeGraph.iScreenID);
        eProcessResult = HMI_ActiveEngine(&g_stDemoEngine, g_stHMIWeActstudio.iScreenID);
        ...
        if (HAL_GetTick() - tick >= 2000)
        {
            ...
            if (!goback)
            {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    HMI_SwitchScreen(HMI_SCREEN_ID_DEMO_SCROLLING_TEXT, NULL);
                    break;
                case 2:
                ...
                case 9:
                    ...
                    break;
                // case 10:
                //     HMI_SwitchScreen(HMI_SCREEN_ID_WeActStudio, NULL);
                // break;
                default:
